jQuery(document).ready(function(){
    ...
    var page_dynamique = jQuery("#calendrier").data("pageid");
    ...
    function ajax_get_calendar(mois_now, annee_now){
        ...
        if ( ( mois_now >= mois && annee_now == annee ) || ( annee_now > annee ) ){
            ...
            jQuery.ajax( {
                ...
                method: "POST",
                url: ajaxurlcalendarsalle,
                data: { page_id: page_dynamique, mois: mois_now, annee: annee_now, action: "init_calendar_salle"}
